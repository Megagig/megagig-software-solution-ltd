  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={
          "relative z-10 flex w-full flex-col bg-surface-raised text-foreground shadow-2xl " +
      ...
      >
        <header className="flex items-start justify-between border-b border-border px-5 py-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="ml-3 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-foreground-subtle hover:bg-foreground/5 hover:text-foreground"
          >
            <X className="h-4 w-4" />
          </button>
        </header>
